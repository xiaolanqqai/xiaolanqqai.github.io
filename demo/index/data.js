...
function data() {
	...
	ww(document.getElementById("ar2"), [
		...
		'https://docs.qq.com', '腾讯文档',
		'https://yandex.com', 'yandex识图',
		'https://trace.moe', '动漫识图',
		'https://yiso.fun', '易搜',
	...
	ww(document.getElementById("ar7"), [
		...
		'https://v.qq.com', '腾讯视频',
		'https://www.iqiyi.com', '爱奇艺',
		'https://www.8666.tv', '樱花风车动漫',
		'https://www.91m.cc', '樱花动漫',
		...
		'https://www.555dianying.cc', '555电影',
		'https://baofa-hotel.cn', '看吧影院',
		'https://www.840f.com', '恐怖世界',
		'https://www.zuankuo.com', '钻阔电影网',
		'https://www.cuihuays.com', '翠花影视',
...
function dataa() {
	...
	ww(document.getElementById("ar15"), [
		...
		'https://www.tokyotosho.info', '东京图书馆',
		'https://yj2207.click/pw', '1024xp',
		'https://www.aventertainments.com', 'Ave',
		'https://javbee.net', 'JAV',
		'https://elsb.i6xh.news', '2048xp',
		'https://s2212v.cc', '2048xp',
		'https://www.nckao41.xyz', '嫩草影院',
...
function datad() {
	...
	wwd(document.getElementById("dar1"), [
		...
		'https://zhuangzhuang.io', '壮壮博客',
		'https://189.zheng98.com', 'adobe下载',
		'https://flowery-espadrille-695.notion.site/7e52fb27108d4b7099aa6245a4d1d9eb', '应用集导航',
		'https://orangefox.download/zh-CN/device/dipper', '小米8第三方twrp',
