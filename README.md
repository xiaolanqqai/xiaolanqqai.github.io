...
BETA 4.0.1-2025-12-03
1：实现选项卡删除功能，鼠标悬停显示删除叉号
2：修复删除选项卡时自动下载文件问题，改为标记数据已修改
3：在版本信息编辑模态框中添加获取最新版本信息按钮，可自动从版本历史文件加载最新版本号和日期
4：修复了a标签初始加载时颜色显示不正确的问题
5：实现了基于北京时间日出日落时间的深色模式自动切换功能
